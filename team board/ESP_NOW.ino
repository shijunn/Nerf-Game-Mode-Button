...
void OnDataRecv(const uint8_t * mac, const uint8_t *incomingData, int len) {
  ...
  incomingcountdowntime = incominggamedata.countdowntime;
}
// CURRENTLY ONLY RECEIVES GAMEMODETIME


// team board only receives game time settings and time up?
// team board sends out score